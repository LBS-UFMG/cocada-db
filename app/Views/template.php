        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-6 ps-5">
                    ...
                    <p style="font-size: 0.75em;color:#ccc">©<?=date('Y')?> COCαDA v1.0 – Interface v2.5.122 | Laboratory of Bioinformatics and Systems, UFMG (Brazil) | <a class="text-white" href="https://github.com/LBS-UFMG/cocada">GitHub</a>
                </div>
